...
console.log(verdict);
```
Guess: The murderer is Mrs. Peacock.
Actual: Can't be reassigned.
...
```
Guess: First Verdict: The murderer is Mrs. Peacock., Second Verdict: undefined.
...
```
Guess: The suspects are Miss Scarlet, Prof. Plum, Colonel Mustard. Suspect three is Mrs. Peacock.
...
console.log(verdict);
```
Guess: The murderer is Mr. Green.
